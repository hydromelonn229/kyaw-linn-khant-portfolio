    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 fixed left-0 top-0 h-screen bg-white border-r border-gray-200 p-6">
        ...
        <nav className="space-y-2">
          <a href="#header" className="block text-gray-600 hover:text-blue-700 transition-colors">Wireless Zigbee Communication</a>
          ...
          <a href="#wiring" className="block text-gray-600 hover:text-blue-700 transition-colors">Wiring Diagrams</a>
        </nav>
      </aside>
      ...
      <main className="flex-1 ml-64">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div id="header" className="mb-12 scroll-mt-20">
            <h1 className="text-4xl font-bold text-blue-900 mb-4">Wireless Zigbee Communication</h1>
